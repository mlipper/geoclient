...
public class AddressParser extends AbstractRegexParser {
    ...
    public void parse(ParseContext parseContext) {
        ...
        MatchBuilder builder = new MatchBuilder().add(matcher).add(MatchType.COMPLETE).add(parseContext).add(REGEX, 1,
            TokenType.HOUSE_NUMBER).add(REGEX, 2, TokenType.HOUSE_NUMBER_SUFFIX).add(REGEX, 3, TokenType.STREET_NAME);
