...
/**
 * Adapts {@code geoclient-service} beans to the framework-neutral SPI
 * contracts published by the {@code geoclient-search} module. Used
 * exclusively from Spring configuration to keep the search module free of
 * any Spring or {@code service}-package types.
 */
