...
public class BblSearchTask extends SearchTask {
    ...
    public BblSearchTask(Request request, GeosupportInvoker geosupport, ResponseStatusReader statusReader) {
    ...
    protected Map<String, Object> doCall() {
        ...
        return this.geosupport.callFunctionBL(bblRequest.getBorough(), bblRequest.getBlock(), bblRequest.getLot());
    }
