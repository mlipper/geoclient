...
public class AddressSearchTask extends SearchTask {
    ...
    public AddressSearchTask(Request request, GeosupportInvoker geosupport, ResponseStatusReader statusReader) {
    ...
    protected Map<String, Object> doCall() {
        ...
        return this.geosupport.callFunction1B(addressRequest.getHouseNumber(), addressRequest.getStreet(),
