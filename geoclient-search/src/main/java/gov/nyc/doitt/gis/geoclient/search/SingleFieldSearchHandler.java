 ...
 */
package gov.nyc.doitt.gis.geoclient.search;
...
import gov.nyc.doitt.gis.geoclient.search.task.SearchTask;
import gov.nyc.doitt.gis.geoclient.search.task.SearchTaskFactory;

public class SingleFieldSearchHandler implements AutoCloseable {
    ...
    public SingleFieldSearchHandler(SearchId searchId, LocationTokenizer locationTokenizer,
