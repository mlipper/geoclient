...
public class PlaceSearchTask extends SearchTask {
    ...
    public PlaceSearchTask(Request request, GeosupportInvoker geosupport, ResponseStatusReader statusReader) {
    ...
    protected Map<String, Object> doCall() {
        ...
        return this.geosupport.callFunction1B(null, // house number
