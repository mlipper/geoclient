...
public class IntersectionSearchTask extends SearchTask {
    ...
    public IntersectionSearchTask(Request request, GeosupportInvoker geosupport, ResponseStatusReader statusReader) {
    ...
    protected Map<String, Object> doCall() {
        ...
        return this.geosupport.callFunction2(intersectionRequest.getCrossStreetOne(), intersectionRequest.getBorough(),
            intersectionRequest.getCrossStreetTwo(), null, // borough cross street
            // two
