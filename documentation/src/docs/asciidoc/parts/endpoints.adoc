...
[NOTE]
====
See <<support-for-geosupport-street-codes,Support for Geosupport Street Codes>> for a discussion of the differences between the `/streetcode` and `/streetcode/b5sc` endpoints.
====
