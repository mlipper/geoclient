...
----
include::../samples/address-100.jsonc[tags=user_guide]
----
====
...
[source,json,indent=0]
----
include::../samples/addresspoint-200.jsonc[tags=user_guide]
----
====
...
[source,json,indent=0]
----
include::../samples/bbl-300.jsonc[tags=user_guide]
----
====
...
[source,json,indent=0]
----
include::../samples/bin-400.jsonc[tags=user_guide]
----
====
...
[source,json,indent=0]
----
include::../samples/blockface-500.jsonc[tags=user_guide]
----
====
...
[source,json,indent=0]
----
include::../samples/intersection-600.jsonc[tags=user_guide]
----
====
...
[source,json,indent=0]
----
include::../samples/normalize-700.jsonc[tags=user_guide]
----
====
...
[source,json,indent=0]
----
include::../samples/place-800.jsonc[tags=user_guide]
----
====
...
[source,json,indent=0]
----
include::../samples/search-900.jsonc[tags=user_guide]
----
====
...
....
/geoclient/v2/streetcode?streetCode=11061001
....
...
[source,json,indent=0]
----
include::../samples/streetcode-1000.jsonc[tags=user_guide]
----
====
...
[NOTE]
====
The `/streetcode/b5sc` endpoint provides the same functionality as `/streetcode` except for the following difference:
...
This is for backward compatibility with older versions of the Geoclient API which returned results in a top-level `response` property/element at the request of an Agency partner.
====

*Path:* `/v2/streetcode/b5sc`

*Parameters:*

.`/streetcode/b5sc` arguments
[cols="1a,1a,2a"]
|===
|Parameter Name |Required/Optional |Comments
...
....
/geoclient/v2/streetcode/b5sc?streetCode=110610
....
...
[source,json,indent=0]
----
include::../samples/streetcode-b5sc-1100.jsonc[tags=user_guide]
----
====
...
[source,json,indent=0]
----
include::../samples/version-1200.jsonc[tags=user_guide]
----
====
