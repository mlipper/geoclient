...
import static geoclientbuild.jarexec.settings.SettingsInfo.DEFAULT_MAP_SUMMARY;
import static geoclientbuild.jarexec.settings.SettingsInfo.ENV_SECTION_TITLE;
import static geoclientbuild.jarexec.settings.SettingsInfo.HTTP_SHUTDOWN_SECTION_TITLE;
import static geoclientbuild.jarexec.settings.SettingsInfo.WORKING_DIR_SECTION_TITLE;
import static geoclientbuild.jarexec.settings.SettingsInfo.appendInfoSection;
import static geoclientbuild.jarexec.settings.SettingsInfo.httpShutdownInfo;
