...
public class OptionSpecs {
    ...
    public static final Map<String, String> OPTIONS_INFO = Map.of(
        OPT_ARG, OPT_TXT_ARG,
        OPT_ENV, OPT_TXT_ENV,
        OPT_HELP, OPT_TXT_HELP,
        OPT_HTTPFILE, OPT_TXT_HTTPFILE,
        OPT_JARFILE, OPT_TXT_JARFILE,
        OPT_JAVACMD, OPT_TXT_JAVACMD,
        OPT_STOP, OPT_TXT_STOP,
        OPT_WORKDIR, OPT_TXT_WORKDIR
    );
}
